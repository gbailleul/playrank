      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          <div 
            ...
            className="dashboard-tile p-6 group hover:shadow-lg transition-shadow duration-200 cursor-pointer"
          >
            <div className="flex items-start justify-between">
              <div>
                ...
                <p className="text-[var(--text-secondary)]">
                  {user ? "Créer une nouvelle partie et inviter des joueurs" : "Connectez-vous pour créer une partie"}
                </p>
              </div>
